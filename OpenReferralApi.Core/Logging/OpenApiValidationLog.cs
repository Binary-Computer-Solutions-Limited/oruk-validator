...
namespace OpenReferralApi.Core.Logging
{
    public static partial class OpenApiValidationLog
    {
        ...
        public static partial void OpenApiValidationMemoryCheckpoint(this ILogger logger, string stage, string correlationId, string baseUrl, string profile, long managedHeapBytes, long managedHeapDeltaBytes, long processWorkingSetBytes, long processWorkingSetDeltaBytes, long gcHeapSizeBytes, long gcHeapSizeDeltaBytes, long gcFragmentedBytes, long gcFragmentedDeltaBytes, long gcTotalCommittedBytes, long gcTotalCommittedDeltaBytes, long gcMemoryLoadBytes, long gcMemoryLoadDeltaBytes, int gen0CollectionsDelta, int gen1CollectionsDelta, int gen2CollectionsDelta, double elapsedMs);
