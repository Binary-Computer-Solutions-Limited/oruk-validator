...
namespace OpenReferralApi.Core.Logging
{
    public static partial class PathParsingLog
    {
        ...
        public static partial void CheckingAccessibilityOfUri(this ILogger logger, string uri);

        [LoggerMessage(EventId = 11001, Level = LogLevel.Warning, Message = "HTTP request failed for URI: {Uri}")]
        public static partial void HttpRequestFailedForUri(this ILogger logger, Exception exception, string uri);

        [LoggerMessage(EventId = 11002, Level = LogLevel.Warning, Message = "Request timeout for URI: {Uri}")]
        public static partial void RequestTimeoutForUri(this ILogger logger, string uri);

        [LoggerMessage(EventId = 11003, Level = LogLevel.Error, Message = "Error checking accessibility of URI: {Uri}")]
        public static partial void ErrorCheckingAccessibilityOfUri(this ILogger logger, Exception exception, string uri);

        [LoggerMessage(EventId = 11004, Level = LogLevel.Error, Message = "Error resolving relative URI '{RelativeUri}' against base '{BaseUrl}'")]
        public static partial void ErrorResolvingRelativeUri(this ILogger logger, Exception exception, string relativeUri, string baseUrl);
        ...
        public static partial void SuccessfullyValidatedUri(this ILogger logger, string uriType, string uri);
        ...
        public static partial void SslCertificateValidationEnabled(this ILogger logger, string uriType, string uri);

        [LoggerMessage(EventId = 11010, Level = LogLevel.Warning, Message = "Potentially unsafe {UriType} accessing private/localhost: {Uri}")]
        public static partial void PotentiallyUnsafeUri(this ILogger logger, string uriType, string uri);
    }
}
